...
Revision ID: 0d8c63283d96
Revises: 
Create Date: 2025-11-02 18:38:25.828751
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('scheduled', 'confirmed', 'waitlist', 'cancelled', 'checked_in', 'waiting', 'called', 'in_consult', 'completed', 'no_show', name='appointment_status'), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
